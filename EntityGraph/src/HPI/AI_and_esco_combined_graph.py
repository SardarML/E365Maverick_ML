...
from sentence_transformer import fill_graph_sentence_transformer
...
AI_skill_graph.serialize('data/HPI/HPI_MIXED_COURSES_big_esco_skill_sentence_transformer_graph.ttl', format='ttl')
