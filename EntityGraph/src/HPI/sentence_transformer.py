...
def get_data(path):
        ...
        identifier = merged_df['courseCode']
...
merged_df, str_lst, vocab, identifier_vocab, identifier, urls, url_vocab = get_data('data\HPI\merged_HPI_data_without_stopwords.csv')
...
# weights.to_csv('data\HPI\merged_HPI_data_embeddings.csv')
# print(weights.shape)

import numpy as np

weights = pd.read_csv('data\HPI\merged_HPI_data_embeddings.csv')
