...
# weights.to_csv('/content/drive/MyDrive/EntityGraph/Graphs/OERSI/data/OERSI_data_embeddings.csv')
# print(weights.shape)

weights = pd.read_csv('data\OERSI\OERSI_data_embeddings.csv')
