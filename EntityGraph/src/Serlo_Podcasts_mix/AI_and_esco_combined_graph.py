...
from podcasts_serlo_combined_sentence_transformer_graph_embeddings import fill_graph_sentence_transformer
...
AI_skill_graph.serialize('data/Serlo_Podcasts_mix/serlo_podcasts_big_esco_skill_sentence_transformer_graph.ttl', format='ttl')
